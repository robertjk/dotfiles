...
nnoremap <Leader>svb  :vsplit  $MYVIMCONFIG/init-parts/basic.vim<CR>
...
nnoremap <Leader>sbr  :vsplit  ~/.bashrc<CR>
nnoremap <Leader>tbr  :tabedit ~/.bashrc<CR>
nnoremap <Leader>ebp  :edit    ~/.bash_profile<CR>
nnoremap <Leader>sbp  :vsplit  ~/.bash_profile<CR>
nnoremap <Leader>tbp  :tabedit ~/.bash_profile<CR>
" i3 config
nnoremap <Leader>esw  :edit    ~/.config/sway/config<CR>
nnoremap <Leader>ssw  :vsplit  ~/.config/sway/config<CR>
nnoremap <Leader>tsw  :tabedit ~/.config/sway/config<CR>
...
map <Leader>cde :edit %%
map <Leader>cds :split %%
map <Leader>cdv :vsplit %%
map <Leader>cdt :tabedit %%
